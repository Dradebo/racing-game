# Striving Observation

This directory contains the state contract and adapters for the Striving Observation layer.

Core doctrine: reality is authoritative; the renderer observes striving.

Deployment topology:
- `main` -> production chassis
